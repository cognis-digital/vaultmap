#!/usr/bin/env sh
# Universal installer for vaultmap. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/vaultmap.git"
echo "Installing vaultmap ..."
