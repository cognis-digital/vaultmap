"""Native cognis-connect emit for vaultmap — forward findings to any platform.

Maps vaultmap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    vaultmap ... --format json | vaultmap-emit --to stix
    vaultmap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
